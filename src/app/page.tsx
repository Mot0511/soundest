    ...
    return (
        <>
            ...
            <div className={cl.infoBlock} id="forwhat">
                ...
                <p className={cl.info}>
                Вы можете выгрузить всю свою скачанную музыку в Soundest, и она будет доступна на любом вашем устройстве (будь то это пк или телефон) c установленным Soundest. На этом же сервисе можно слушать музыку: как загруженную в облако, так и локальные mp3 файлы.<br /><br />
